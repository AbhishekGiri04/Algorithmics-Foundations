...
│   ├── 📊 array/ (23 problems)       # Array-based problems
...
│   │   ├── leetcode-66.cpp           # Plus One (Easy)
│   │   ├── leetcode-74.cpp           # Search 2D Matrix (Medium)
│   │   ├── leetcode-75.cpp           # Sort Colors (Medium)
│   │   ├── leetcode-81.cpp           # Search in Rotated Sorted Array II (Medium)
...
│   │   ├── leetcode-154.cpp          # Find Minimum in Rotated Sorted Array II (Hard)
...
│   │   ├── leetcode-1721.cpp         # Swapping Nodes in a Linked List (Medium)
...
│   │
│   ├── 🌳 tree/ (3 problems)          # Tree-based problems
│   │   ├── leetcode-110.cpp          # Balanced Binary Tree (Easy)
│   │   ├── leetcode-865.cpp          # Smallest Subtree with all the Deepest Nodes (Medium)
